...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::get("system/login_history",[ActivityLogController::class,'login_history']);

    // notification
    Route::get("module/notification/get",[NotificationController::class,'notification']);
    Route::get("module/notification/read/{id}",[NotificationController::class,'read']);

    //dashboard
    Route::get("dashboard/get_report_charts",[DashboardController::class,'get_report_chart']);
    Route::get("dashboard/widget/{module}/{field?}/{operator?}/{value?}",[DashboardController::class,'get_widget']);
    Route::get("dashboard/chart/incident_trend_month",[DashboardController::class,'incident_trend_month']);
    Route::get("dashboard/chart/incident_status",[DashboardController::class,'incident_status']);
    Route::get("dashboard/systemlogs",[DashboardController::class,'get_systemlogs']);
    ...
    Route::get("module/delete_all/{module}",[ModuleController::class,'delete_all']);
    Route::get("module/get_single_item/{module}/{id}",[ModuleController::class,'get_single_item']);
    Route::get("module/set_single_item/{id}/{fieldid}/{field}",[ModuleController::class,'set_single_item']);
