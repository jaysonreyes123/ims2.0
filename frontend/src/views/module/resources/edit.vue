        ...
        <Block blockname="Resources Information">
            <div class="lg:grid lg:grid-cols-2 gap-12">
                ...
                <div class="fromGroup relative">
                    ...
                    <Select placeholder="Select an option" :options="ResourceStore.getResourceType" :reduce="label => label.value"  v-model="ResourceStore.form.resources_type" />
                </div>
            ...
            <div class="lg:grid lg:grid-cols-2 gap-12">
                ...
                <div class="fromGroup relative">
                    ...
                    <Select placeholder="Select an option" :options="ResourceStore.getResourceStatus" :reduce="label => label.value"  v-model="ResourceStore.form.resources_status" />
                </div>
            </div>
            ...
            <div class="lg:grid lg:grid-cols-2 gap-12">
                ...
                <div class="fromGroup relative">
                    ...
                    <Select placeholder="Select an option" :options="ResourceStore.getResourceDispatch" :reduce="label => label.value"  v-model="ResourceStore.form.dispatch" />
                </div>
            </div>
            ...
            <div class="lg:grid lg:grid-cols-2 gap-12">
                ...
                <div class="fromGroup relative">
                    ...
                    <Select placeholder="Select an option" :options="ResourceStore.getResourceCondition" :reduce="label => label.value"  v-model="ResourceStore.form.condition" />
                </div>
            </div>
        </Block>
